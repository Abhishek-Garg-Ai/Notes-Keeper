...
public class EditNote_textDetection extends AppCompatActivity {
    ...
    public static String scan_content;
                ...
                if(!recognizer.isOperational()){
                    ...
                    okBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String previousContent=prevIntent.getStringExtra("content");
                            String editContent=previousContent+sb.toString();
                            Intent i = new Intent(getApplicationContext(), com.abhigarg.notepadapp.note.EditNote.class);
                            i.putExtra("title", prevIntent.getStringExtra("title"));
                            i.putExtra("content", editContent);
                            i.putExtra("noteId", prevIntent.getStringExtra("noteId"));
                            i.putExtra("textColor", prevIntent.getIntExtra("textColor",Color.BLACK));
                            i.putExtra("backgroundColor",prevIntent.getIntExtra("backgroundColor",Color.WHITE));
                            startActivity(i);
                            finish();

                           scan_content=sb.toString();
                           onBackPressed();
